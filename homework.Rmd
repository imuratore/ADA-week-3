...
sigma <- sqrt(sum((w - mean(w))^2)/length(w))

pop_se <- sigma/sqrt(n)
pop_se 

upper <- mean(w) + qnorm(0.95, mean = mean(w), sd = stdev) * pop_se
lower <- mean(w) + qnorm(0.05, mean = mean(w), sd = stdev) * pop_se  
ci <- c(lower, upper)
ci
...
sigma <- sqrt(sum((a - mean(a))^2)/length(a))

pop_se <- sigma/sqrt(n)
pop_se 

upper <- mean(a) + qnorm(0.95, mean = mean(a), sd = stdev) * pop_se
lower <- mean(a) + qnorm(0.05, mean = mean(a), sd = stdev) * pop_se  
ci <- c(lower, upper)
ci
...
sigma <- sqrt(sum((z - mean(z))^2)/length(z))

pop_se <- sigma/sqrt(n)
pop_se 

upper <- mean(z) + qpois(0.95, lambda=mean(z), lower.tail = TRUE, log.p = FALSE) * pop_se
lower <- mean(z) + qpois(0.05, lambda=mean(z), lower.tail = TRUE, log.p = FALSE) * pop_se  
ci <- c(lower, upper)
ci
...
sigma <- sqrt(sum((y - mean(y))^2)/length(y))

pop_se <- sigma/sqrt(n)
pop_se 

upper <- mean(y) + qpois(0.95, lambda=mean(y), lower.tail = TRUE, log.p = FALSE) * pop_se
lower <- mean(y) + qpois(0.05, lambda=mean(y), lower.tail = TRUE, log.p = FALSE) * pop_se  
ci <- c(lower, upper)
ci
