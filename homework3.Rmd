...
# second homework problem (please ignore for now)
...
upper <- mean(m) + qnorm(0.95, mean = mean(m), sd = stdev) * mean(sem)
lower <- mean(m) + qnorm(0.05, mean = mean(m), sd = stdev) * mean(sem)
ci <- c(lower, upper)
ci
